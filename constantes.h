...
const int MaxDimensie = 10;  // maximaal aantal rijen en maximaal aantal
                             // kolommen op het bord
const int MaxKleurenVormen = 10;  // maximaal aantal kleuren of verschillende
                                  // vormen
const int MaxKeuzeAantal = 5;  // maximaal aantal stenen in hand van speler
const int Leeg = -1;           // een niet-geldig nummer voor kleur of vorm
const int NrSimulaties = 100;  // voor Monte Carlo simulatie
const pair<int,int> GeenSteen = make_pair (-1,-1);  // ongeldige steen
